...
export class MessageService {
  ...
  showSuccess(title: string, message: string, duration?: number): void {
    this.showMessage({ type: MessageType.SUCCESS, title, message, duration });
  }

  showError(title: string, message: string, duration?: number): void {
    this.showMessage({ type: MessageType.ERROR, title, message, duration });
  }

  showWarning(title: string, message: string, duration?: number): void {
    this.showMessage({ type: MessageType.WARNING, title, message, duration });
  }

  showInfo(title: string, message: string, duration?: number): void {
    this.showMessage({ type: MessageType.INFO, title, message, duration });
  }
